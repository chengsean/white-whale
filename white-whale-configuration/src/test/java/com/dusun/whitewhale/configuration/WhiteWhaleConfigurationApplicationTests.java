...
@SpringBootTest
public class WhiteWhaleConfigurationApplicationTests {

    private static final Logger LOGGER = LoggerFactory.getLogger(WhiteWhaleConfigurationApplicationTests.class);
