...
package com.dusun.whitewhale.gateway;
...
public class ThrottleGatewayFilter implements GatewayFilter {
	...
	ThrottleGatewayFilter setCapacity(int capacity) {
	...
	ThrottleGatewayFilter setRefillTokens(int refillTokens) {
	...
	ThrottleGatewayFilter setRefillPeriod(int refillPeriod) {
