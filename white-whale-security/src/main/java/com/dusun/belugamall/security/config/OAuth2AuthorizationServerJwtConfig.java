...
/**
 * OAuth2AuthorizationServerJwt 配置
 * @author 程绍壮
 * @date 2019-10-23 00:34
*/
@Configuration
...
public class OAuth2AuthorizationServerJwtConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(final AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        endpoints.tokenStore(tokenStore()).tokenEnhancer(tokenEnhancerChain).authenticationManager(this.authenticationManager);
    }
