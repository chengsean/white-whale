...
import com.dusun.belugamall.security.controller.TokenController;
...
@SpringBootTest(classes = { BelugaMalSecurityApplication.class, TokenController.class }, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
