...
import com.dusun.whitewhale.security.controller.TokenController;
...
@SpringBootTest(classes = { WhiteWhaleSecurityApplication.class, TokenController.class }, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@AutoConfigureMockMvc
public class TokenControllerIntegrationTest {
    //    private static final Logger LOG = LoggerFactory.getLogger(TokenControllerIntegrationTest.class);
